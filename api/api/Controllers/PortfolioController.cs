...
namespace api.Controllers
{
	...
	public class PortfolioController : ControllerBase
	{
		...
		public PortfolioController(UserManager<AppUser> userManager, IStockRepository stockRepo, IPortfolioRepository portfolioRepo, IFMPService fmpSerivce)
		{
			_userManager = userManager;
			_stockRepo = stockRepo;
			_portfolioRepo = portfolioRepo;
			_fmpSerivce = fmpSerivce;
		}
